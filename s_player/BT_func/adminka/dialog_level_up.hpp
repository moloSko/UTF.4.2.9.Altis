#define PROGBAR_X ((safezoneX + (safezoneW / 2)) - (safezoneH / 2))
#define PROGBAR_Y safezoneY
#define PROGBAR_W safezoneH
#define PROGBAR_H (safezoneH / 5)
#define PROGBAR_OTSTUP (PROGBAR_H / 5)
#define PROGBAR_W_CONTROL ((PROGBAR_W / 4) - (PROGBAR_OTSTUP * 5))
#define PROGBAR_H_CONTROL ((PROGBAR_H / 3) - (PROGBAR_OTSTUP * 4))
#define PROGBAR_W_PROGRESS ((PROGBAR_W * 4) + (PROGBAR_OTSTUP * 3))

class progresslevelup
{
    idd = 5555;
	duration = 1e+10; 
    fadeIn = 0;
    fadeOut = 0;
    onLoad = "uiNamespace setVariable ['PROGBAR',_this select 0]";
    class Controls
    {
